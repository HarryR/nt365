...
// courtesy of USER!  (Also see SRVQUICK.C, APIREQST.C)
    ...
    DbgPrint("CSRSRV: init/3 NtQuerySystemInformation\n");
    ...
    DbgPrint("CSRSRV: init/4 CsrSetProcessSecurity\n");
    Status = CsrSetProcessSecurity();
    ASSERT( NT_SUCCESS( Status ) );

    DbgPrint("CSRSRV: init/5 CsrInitializeNtSessionList\n");
    Status = CsrInitializeNtSessionList();
    ASSERT( NT_SUCCESS( Status ) );

    DbgPrint("CSRSRV: init/6 CsrInitializeProcessStructure\n");
    ...
    DbgPrint("CSRSRV: init/10 CsrSbApiPortInitialize\n");
    Status = CsrSbApiPortInitialize();
    ASSERT( NT_SUCCESS( Status ) );

    DbgPrint("CSRSRV: init/11 SmConnectToSm\n");
